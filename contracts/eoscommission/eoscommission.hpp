...
class eosnames : public contract
{

  public:
    eosnames(account_name self) : contract(self) {}
    ...
    // void changekey(const account_name _acct,
    //                const public_key _new_owner_key,
    //                const public_key _new_active_key,
    //                const bool _addcode);

    // void newacct(const string _acctname,
    //              const public_key _key);
